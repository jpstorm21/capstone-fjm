...
export class MigrantsPersonsResolver {
    ...
    async createMigrantPerson(@Args('input') args: MigrantPersonData): Promise<MigrantPerson> {
    ...
    async editMigrantPerson(@Args('id') id: string, @Args('input') args: MigrantPersonData): Promise<MigrantPerson> {
